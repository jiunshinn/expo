...
- An Expo project linked to EAS with `eas init`
...
<Terminal
  cmd={[
    '$ eas integrations:convex:connect --region aws-us-east-1 --team-name "Acme" --project-name "acme-app"',
  ]}
/>
...
For an Expo Router project, update **app/\_layout.tsx**:
